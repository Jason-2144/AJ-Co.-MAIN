  ...
  return (
    <>
      <section className="relative pt-32 pb-24 overflow-hidden bg-[#0A0A0A]">
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          <motion.h1 
            ...
            className="font-syne text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight mb-8 text-white leading-tight"
          >
      ...
      <section className="py-24 container mx-auto px-6 max-w-3xl">
         <motion.div initial="hidden" whileInView="visible" viewport={{ once:true }} variants={staggerContainer} className="space-y-8 text-lg md:text-xl text-gray-300 leading-relaxed font-sans mb-32">
         ...
         <motion.div initial="hidden" whileInView="visible" viewport={{ once:true }} variants={staggerContainer} className="mb-32">
         ...
         <motion.div initial="hidden" whileInView="visible" viewport={{ once:true }} variants={staggerContainer}>
            ...
            <div className="space-y-6 text-lg text-gray-300 leading-relaxed font-sans glass p-10 rounded-2xl border border-white/10 bg-[#10B981]/5">
      ...
      <section className="py-32 relative text-center border-t border-white/5 bg-white/[0.01]">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="font-syne text-3xl md:text-4xl font-bold text-white mb-12">Want To Work With A Team That Stays Until It Works?</h2>
