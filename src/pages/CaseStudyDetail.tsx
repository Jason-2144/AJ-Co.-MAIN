...
export default function CaseStudyDetail() {
  ...
  if (!data) return <div className="py-40 text-center text-white">Case study not found.</div>;
  ...
  return (
    <>
      <section className="relative pt-32 pb-24 border-b border-white/5 bg-[#0A0A0A]">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <motion.h1 
            ...
            className="font-syne text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-8 text-white leading-[1.1]"
          >
            {data.title}
          </motion.h1>
        </div>
      ...
      <section className="py-16 container mx-auto px-6 max-w-4xl space-y-24">
      ...
      <section className="py-32 relative text-center border-t border-white/5 bg-[#0A0A0A]">
