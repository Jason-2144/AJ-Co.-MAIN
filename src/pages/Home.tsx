...
const StickyScrollServices = () => {
  const services = [
    { num: "01", icon: Bot, title: "AI Automation", desc: "Replace repetitive workflows with intelligent automation pipelines.", link: "/services/workflow-automation" },
    { num: "02", icon: Cpu, title: "AI Agents", desc: "Custom agents that work, decide, and execute tasks without human input.", link: "/services/custom-agent-development" },
    { num: "03", icon: Plug, title: "AI Integrations", desc: "Connect AI to your existing tools — CRM, Slack, ERPs, anything.", link: "/services/workflow-automation" },
    { num: "04", icon: MessageSquare, title: "AI Chatbots", desc: "24/7 intelligent chat for sales, support, and internal ops.", link: "/services/custom-agent-development" },
    { num: "05", icon: Globe, title: "Web Development", desc: "Production-grade web systems built to perform and convert.", link: "/services" }
  ];

  return (
    <section className="bg-[#0A0A0A] border-t border-white/5 py-24 lg:py-32">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
             {services.map((srv, i) => (
               <Link to={srv.link} key={i} className="block h-full">
                 <motion.div variants={fadeUp} className="border border-white/10 p-8 lg:p-10 flex flex-col gap-4 hover:bg-white/[0.03] hover:border-emerald-500/30 transition-all rounded-2xl cursor-pointer group h-full">
