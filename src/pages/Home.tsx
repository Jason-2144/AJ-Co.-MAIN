...
export default function Home() {
  ...
  const workCards = [
    {
      tag: "E-Mobility | Chennai", name: "NURA Electric Mobility",
    ...
    {
      tag: "Sports | Hyderabad", name: "Hyderabad Pickleball Association",
    ...
    {
      tag: "SEO | Link Building", name: "Stan Ventures",
  ...
  return (
    <>
      ...
      {/* What We Do */}
      <section className="bg-[#0A0A0A] py-24 lg:py-32 border-t border-white/5">
        <div className="container mx-auto flex flex-col items-center px-4 max-w-3xl text-center mb-16">
        ...
        <div className="overflow-x-auto scroll-smooth [&::-webkit-scrollbar]:hidden flex flex-row gap-0 border-y border-white/10 snap-x snap-mandatory">
           {/* Serivce Blocks */}
           {[
             ...
             { num: "06", icon: Layers, title: "Full AI Transformation", desc: "Strategy to deployment. We run the entire AI build end-to-end." }
           ].map((srv, i) => (
             <div key={i} className="min-w-[85vw] sm:min-w-[280px] md:min-w-[320px] border-r border-white/10 last:border-r-0 p-8 lg:p-10 flex flex-col gap-4 hover:bg-white/[0.03] transition-colors cursor-pointer group snap-start shrink-0">
                <span className="font-mono text-xs text-white/20 tracking-widest">{srv.num}</span>
                <div className="w-10 h-10 bg-emerald-500/10 p-2 rounded-lg text-emerald-400">
