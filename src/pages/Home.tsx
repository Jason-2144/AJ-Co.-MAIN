...
import { 
  ArrowRight, Activity, Zap, BarChart, 
  Layers, Shield, Cpu, Quote 
} from 'lucide-react';
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-32 overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center max-w-5xl">
         ...
         >
            <Link to="/contact" className="bg-white text-black px-8 py-4 rounded-none font-syne font-bold uppercase text-xs tracking-widest hover:bg-[#10B981] transition-colors w-full sm:w-auto flex items-center justify-center">
                Book Strategy Call
            </Link>
            <Link to="/case-studies" className="border border-white/20 px-8 py-4 rounded-none font-syne font-bold uppercase text-xs tracking-widest hover:bg-white/5 transition-colors w-full sm:w-auto flex items-center justify-center">
                See Our Work
            </Link>
         </motion.div>
      </div>
   ...
   const cases = [
       {
           ...
           link: "/case-studies/ecommerce-support-automation"
       },
       {
           id: "02",
           ...
           link: "/case-studies/sales-lead-qualification"
       },
       {
           id: "03",
           ...
           link: "/case-studies/internal-operations-assistant"
       }
   ];
               ...
               >
                   {cases.map((cs) => (
                       <motion.div key={cs.id} variants={fadeUp} className="glass flex flex-col p-10 rounded-xl group hover:shadow-[0_0_40px_rgba(16,185,129,0.05)] hover:-translate-y-2 transition-all duration-500 bg-white/[0.02]">
                           ...
                           <Link to={cs.link} className="inline-flex items-center gap-3 text-emerald-400 text-sm font-bold group-hover:text-emerald-300 transition-colors mt-auto w-max uppercase tracking-wider">
    ...
    return (
        <section className="py-32 md:py-48 relative overflow-hidden border-t border-white/5 mt-16">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center text-white">
                 ...
                 <Link to="/contact" className="inline-flex items-center justify-center bg-[#10B981] hover:brightness-110 text-black px-12 py-5 rounded-none font-syne font-bold emerald-glow transition-all uppercase text-sm tracking-widest cursor-pointer">
